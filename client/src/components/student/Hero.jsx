...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-70 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
       ...
       <p className='text-[15px] leading-[21px] text-gray-500 max-w-2xl mx-auto'>
