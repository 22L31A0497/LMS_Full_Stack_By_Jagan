    ...
    <div className='pb-14 px-8 md:px-0'>
      ...
      <div className='flex flex-wrap gap-8 justify-center mt-14'>
        {dummyTestimonial.map((testimonial, index) => (
          <div key={index} className='w-full md:w-[calc(33.33%-1rem)] lg:w-[calc(25%-1rem)] text-sm text-left border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
