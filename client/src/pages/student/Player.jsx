...
const Player = () => {
  ...
  return (
    <>
      <div className='p-4 sm:p-10 felx-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        <div>
          {/* left colum*/}
                    ...
                    <ul className='list-disc md:pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className='flex items-start gap-2 py-1'>
                          <img src={lecture.lectureUrl ? assets.play_icon : assets.blue_tick_icon} alt='play icon' className='w-4 h-4 mt-1' />
         ...
         <div className='flex items-center gap-2 py-3 mt-10'>
          ...
          <Rating initialRating={courseData ? courseData.courseRating : 0} onRate={(value) => console.log('Rated:', value)} />
         </div>
